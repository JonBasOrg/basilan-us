...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "The browser-native home for the Classic Games Collection — the same Flutter codebase compiled to the web, so Android and browser share the exact game engines, AI, difficulty levels, and local-first persistence. Play on desktop or mobile with mouse, touch, and keyboard.",
    category: "Web",
    status: "Live",
    year: 2026,
    featured: true,
    ...
    image: null,
    useMockup: "games",
    technologies: ["Flutter", "Dart", "Web", "Local-first Storage", "Responsive"],
